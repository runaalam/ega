...
//  EGA
//
//  Created by Runa Alam on 14/04/2015.
...
class DatePickerDialog: UIView {
    ...
    func show(#title: String, _ datePickerMode: UIDatePickerMode = .dateAndTime, callback: ((_ date: Date) -> Void)) {
        show(title, cancelButtonTitle: "Cancel", defaultDate: "Done", datePickerMode: datePickerMode, callback: callback)
    }
    
    func show(#title: String, _ doneButtonTitle: String, cancelButtonTitle: String, defaultDate: Date = Date(), datePickerMode: UIDatePickerMode = .dateAndTime, callback: @escaping ((_ date: Date) -> Void)) {
        
        NSLog("------ Inside Calender  ------ .")
    ...
    fileprivate func addButtonsToView(_ container: UIView) {
        ...
        self.cancelButton = UIButton.withType(UIButtonType.custom) 
        ...
        self.doneButton = UIButton.withType(UIButtonType.custom) 
